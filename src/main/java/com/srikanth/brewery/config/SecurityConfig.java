        ...
        http
                .authorizeRequests(authorize -> {
                    authorize
                            ...
                            //.mvcMatchers(HttpMethod.POST,  "/customers/new").hasRole("ADMIN") //alternate is to provide method level security using preAuthorize and prePostEnabled = true on top of securityConfig class
